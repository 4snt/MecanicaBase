...
import domain.usecases.usuarios.administrador.AtualizarAdministradorUseCase;
import domain.usecases.usuarios.administrador.CriarAdministradorUseCase;
import domain.usecases.usuarios.administrador.ListarAdministradorUseCase;
import domain.usecases.usuarios.administrador.RemoverAdministradorUseCase;
import domain.usecases.usuarios.funcionario.AtualizaFuncionarioUseCase;
import domain.usecases.usuarios.funcionario.CriarFuncionarioUseCase;
import domain.usecases.usuarios.funcionario.ListaFuncionarioUseCase;
import domain.usecases.usuarios.funcionario.RemoveFuncionarioUseCase;
